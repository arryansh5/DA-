...
function ProjectCard({ p, i, visible }) {
  return (
    <Anim visible={visible} delay={200 + i * 80}>
  ...
  return (
    <section className="page projects-page">
      <div className="projects-inner">
        ...
        <div className="proj-scroll proj-scroll--desktop" ref={scrollRef}>
          {PROJECTS.map((p, i) => (
            <ProjectCard key={i} p={p} i={i} visible={visible} />
          ))}
        </div>

        {/* MOBILE: vertical stack */}
        <div className="proj-stack--mobile">
          {PROJECTS.map((p, i) => (
            <ProjectCard key={i} p={p} i={i} visible={visible} />
          ))}
        </div>
